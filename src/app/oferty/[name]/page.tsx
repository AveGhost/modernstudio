...
const SingleOffer = () => {
    ...
    return (
        <main className="px-6 xl:px-0">
            ...
            <div className="grid grid-cols-2 gap-20 py-25 w-full">
            ...
            <div className="flex items-center gap-12 pb-40">
                <div className="relative w-full max-w-[170px] aspect-square rounded-full">
